...
func (x *ConfigsRequest) GetConfigs() map[string]string {
	if x != nil {
		return x.Configs
	}
	return nil
...
var file_notifier_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d,
	0x70, 0x74, 0x79, 0x22, 0x8d, 0x01, 0x0a, 0x0e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x73, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x3f, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x69,
	0x65, 0x72, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	,
...
var file_notifier_proto_goTypes = []interface{}{
	(*Empty)(nil),          // 0: notifier.Empty
	(*ConfigsRequest)(nil), // 1: notifier.ConfigsRequest
	nil,                    // 2: notifier.ConfigsRequest.ConfigsEntry
}
var file_notifier_proto_depIdxs = []int32{
	2, // 0: notifier.ConfigsRequest.configs:type_name -> notifier.ConfigsRequest.ConfigsEntry
	1, // 1: notifier.Notifier.LoadConfigs:input_type -> notifier.ConfigsRequest
	0, // 2: notifier.Notifier.UpdateX509SVID:input_type -> notifier.Empty
	0, // 3: notifier.Notifier.LoadConfigs:output_type -> notifier.Empty
	0, // 4: notifier.Notifier.UpdateX509SVID:output_type -> notifier.Empty
